...
- [x] Implement dashboard pipeline visual.
- [x] Upgrade `FinanceBatchList` ke TanStack Table.
- [x] Tambahkan aging/SLA alert.
- [x] Implement drag & drop payment proof upload.
- [x] Tambahkan laporan & ekspor.
- [x] Pastikan permissions/capabilities keuangan masih valid.
